...
- Напоминания про здоровье
- Улучшения знакомства с сайтом
- Частичное внедрение социальных сетей
- Создание системы рейтинга для пользователей
- Создание системы баллов
- Внедрение деловых игр и соревнований по дисциплинам
- Возможность получения бесплатного курса при сдаче экзамена на 100%.
- Микрооткрытия - создание короткометражных (до 2 мин.) видео на научные темы
- Создание маскота
